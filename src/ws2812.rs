...
impl<'d, P: Instance, const S: usize> Ws2812<'d, P, S> {
    ...
    pub async fn write(&mut self, colors: &[RGB8]) {
        ...
        // Must wait > 300us to reset chain of commands
        // Allow time for FIFO to drain 4x1.25us + 300us low signal
        // Older ws2812s may need 1ms for this.
        // Newer ws2812b strips need only 6us
        // 6 + (1.25 * 4) = 11us
        Timer::after(Duration::from_micros(11)).await;
    }
}
